...
simulations_simple_both = function(N = 250, N_iter=100, coef_main = c(3,1,2), sigma = c(1,1,1,1,1,1,1), criterion ="AICc", seed = 777, crossover = c("min","max"), boot = NULL, reverse_code=FALSE, print=FALSE, beta_param=c(2,2), c=5, include_noGxE_models=FALSE, pvalue=FALSE){
	set.seed(seed)

	models = matrix(0, nrow=7,ncol=7)
	models2 = matrix(0, nrow=7,ncol=4)
	...
	rownames(models) = c("Vantage sensitivity WEAK", "Vantage sensitivity STRONG", "Differential susceptibility WEAK", "Differential susceptibility STRONG","Diathesis-stress WEAK", "Diathesis-stress STRONG","None")
	colnames(models2) = c("Vantage sensitivity", "Differential susceptibility","Diathesis-stress","?")
	rownames(models2) = c("Vantage sensitivity WEAK", "Vantage sensitivity STRONG", "Differential susceptibility WEAK", "Differential susceptibility STRONG","Diathesis-stress WEAK", "Diathesis-stress STRONG","None")
	for (i in 1:N_iter){
		if (print) print(i)
		...
		# No GxE
		ex_noGxE = example2_with_crossover(N=N, c=5, coef_main = c(coef_main[1],0,0), sigma=sigma[7], seed = seed+i, beta_param=beta_param)

		# Automatic testing of all 4 models
		total_n = rep(N_iter,7)
		for (j in 1:7){
			if (j==1) GxE_test = GxE_interaction_test(data.frame(y=ex_van$data$y), data.frame(g=ex_van$data$g), data.frame(e=ex_van$data$e), formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==2) GxE_test = GxE_interaction_test(data.frame(y=ex_van_s$data$y), data.frame(g=ex_van_s$data$g), data.frame(e=ex_van_s$data$e), formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==3) GxE_test = GxE_interaction_test(data.frame(y=ex_ds$data$y), data.frame(g=ex_ds$data$g), data.frame(e=ex_ds$data$e), formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==4) GxE_test = GxE_interaction_test(data.frame(y=ex_ds_s$data$y), data.frame(g=ex_ds_s$data$g), data.frame(e=ex_ds_s$data$e), formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==5) GxE_test = GxE_interaction_test(data.frame(y=ex_dia$data$y), data.frame(g=ex_dia$data$g), data.frame(e=ex_dia$data$e), formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==6) GxE_test = GxE_interaction_test(data.frame(y=ex_dia_s$data$y), data.frame(g=ex_dia_s$data$g), data.frame(e=ex_dia_s$data$e), formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==7) GxE_test = GxE_interaction_test(data.frame(y=ex_noGxE$data$y), data.frame(g=ex_noGxE$data$g), data.frame(e=ex_noGxE$data$e), formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			...
			if (j==7) GxE_test2 = GxE_interaction_RoS(data.frame(y=ex_noGxE$data$y), data.frame(g=ex_noGxE$data$g), data.frame(e=ex_noGxE$data$e), formula_noGxE = y ~ 1, reverse_code=reverse_code, maxiter=500)
			...
			# Check if significant interaction, yes or no
			if (pvalue){
				if (!is.null(GxE_test_best)){
					if (coef(summary(GxE_test_best)$fit_main)["G:E",4] > .05) best_i = 7
				}
			}
...
simulations_both = function(N = 250, N_iter=100, coef_main = c(3,1,2), sigma = c(1,1,1,1,1,1,1), criterion ="AICc", seed = 777, crossover = c("min","max"), boot = NULL, reverse_code=FALSE, print=FALSE, beta_param=c(2,2), c=5, include_noGxE_models=FALSE, pvalue=FALSE){
	set.seed(seed)
	...
	for (i in 1:N_iter){
		...
		# No GxE
		ex_noGxE = example_with_crossover(N=N, c=5, coef_main = c(coef_main[1],0,0), sigma=sigma[7], seed = seed+i, beta_param=beta_param)

		# Automatic testing of all 4 models
		total_n = rep(N_iter,7)
		for (j in 1:7){
			if (j==1) GxE_test = GxE_interaction_test(ex_van$data, ex_van$G, ex_van$E, formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==2) GxE_test = GxE_interaction_test(ex_van_s$data, ex_van_s$G, ex_van_s$E, formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==3) GxE_test = GxE_interaction_test(ex_ds$data, ex_ds$G, ex_ds$E, formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==4) GxE_test = GxE_interaction_test(ex_ds_s$data, ex_ds_s$G, ex_ds_s$E, formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==5) GxE_test = GxE_interaction_test(ex_dia$data, ex_dia$G, ex_dia$E, formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==6) GxE_test = GxE_interaction_test(ex_dia_s$data, ex_dia_s$G, ex_dia_s$E, formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)
			if (j==7) GxE_test = GxE_interaction_test(ex_noGxE$data, ex_noGxE$G, ex_noGxE$E, formula_noGxE = y ~ 1, crossover = crossover, criterion=criterion, boot = boot, reverse_code=reverse_code, maxiter=500, include_noGxE_models=include_noGxE_models)

			if (j==1) GxE_test2 = GxE_interaction_RoS(ex_van$data, ex_van$G, ex_van$E, formula_noGxE = y ~ 1, reverse_code=reverse_code, maxiter=500, t_alpha = .0001)
			if (j==2) GxE_test2 = GxE_interaction_RoS(ex_van_s$data, ex_van_s$G, ex_van_s$E, formula_noGxE = y ~ 1, reverse_code=reverse_code, maxiter=500, t_alpha = .0001)
			if (j==3) GxE_test2 = GxE_interaction_RoS(ex_ds$data, ex_ds$G, ex_ds$E, formula_noGxE = y ~ 1, reverse_code=reverse_code, maxiter=500, t_alpha = .0001)
			if (j==4) GxE_test2 = GxE_interaction_RoS(ex_ds_s$data, ex_ds_s$G, ex_ds_s$E, formula_noGxE = y ~ 1, reverse_code=reverse_code, maxiter=500, t_alpha = .0001)
			if (j==5) GxE_test2 = GxE_interaction_RoS(ex_dia$data, ex_dia$G, ex_dia$E, formula_noGxE = y ~ 1, reverse_code=reverse_code, maxiter=500, t_alpha = .0001)
			if (j==6) GxE_test2 = GxE_interaction_RoS(ex_dia_s$data, ex_dia_s$G, ex_dia_s$E, formula_noGxE = y ~ 1, reverse_code=reverse_code, maxiter=500, t_alpha = .0001)
			if (j==7) GxE_test2 = GxE_interaction_RoS(ex_noGxE$data, ex_noGxE$G, ex_noGxE$E, formula_noGxE = y ~ 1, reverse_code=reverse_code, maxiter=500, t_alpha = .0001)
...
sim_R2byN_simple = function(N=c(100,250,500,1000,2000), N_iter=100, R2 = c(.05, .10, .15), coef_main = c(3,1,2), criterion ="BIC", seed = 777, crossover = c("min","max"), boot = NULL, reverse_code=FALSE, print=FALSE, beta_param=c(2,2), c=5, include_noGxE_models=FALSE, pvalue=FALSE){
	accuracy1 = matrix(0, nrow=length(N),ncol=length(R2))
	accuracy2 = matrix(0, nrow=length(N),ncol=length(R2))
	true_negative1 = matrix(0, nrow=length(N),ncol=length(R2))
	true_negative2 = matrix(0, nrow=length(N),ncol=length(R2))
	for (j in 1:length(N)){
		for (k in 1:length(R2)){

			sigma = c(get_sigma_eps_ex2(R2[k], coef_main=coef_main,c=0, beta_param=beta_param), get_sigma_eps_ex2(R2[k], coef_main=c(coef_main[1],0,coef_main[3]),c=0, beta_param=beta_param), get_sigma_eps_ex2(R2[k], coef_main=coef_main, c=c, beta_param=beta_param), get_sigma_eps_ex2(R2[k], coef_main=c(coef_main[1],0,coef_main[3]),c=c, beta_param=beta_param), get_sigma_eps_ex2(R2[k], coef_main=coef_main,c=10, beta_param=beta_param), get_sigma_eps_ex2(R2[k], coef_main=c(coef_main[1],0,coef_main[3]),c=10, beta_param=beta_param), get_sigma_eps_ex2(R2[k], coef_main=c(coef_main[1],coef_main[2],0),c=5, beta_param=beta_param))
			results = simulations_simple_both(N = N[j], N_iter=N_iter, coef_main = coef_main, sigma = sigma, criterion =criterion, seed = seed, crossover = crossover, boot = boot, reverse_code=reverse_code, print=print, beta_param=beta_param, c=c, include_noGxE_models=include_noGxE_models, pvalue=pvalue)
			...
			# True negative rates
			true_negative1[j,k] = results[[1]][7,7]
			true_negative2[j,k] = results[[2]][7,4]

		}
	}
	return(list(accuracy_confirmatory=accuracy1,accuracy_RoS=accuracy2, true_negative_confirmatory=true_negative1, true_negative_RoS=true_negative2))
}
...
sim_R2byN = function(N=c(100,250,500,1000,2000), N_iter=100, R2 = c(.10, .20, .40), coef_main = c(3,1,2), criterion ="BIC", seed = 777, crossover = c("min","max"), boot = NULL, reverse_code=FALSE, print=FALSE, beta_param=c(2,2), c=5, include_noGxE_models=FALSE, pvalue=FALSE){
	accuracy1 = matrix(0, nrow=length(N),ncol=length(R2))
	accuracy2 = matrix(0, nrow=length(N),ncol=length(R2))
	true_negative1 = matrix(0, nrow=length(N),ncol=length(R2))
	true_negative2 = matrix(0, nrow=length(N),ncol=length(R2))
	for (j in 1:length(N)){
		for (k in 1:length(R2)){
			...
			# Using AICc in certain cases (lead to a bit more false positive but not too much)
			if (criterion == "mixed"){
				if (N[j] <= 100) criterion_ = "AICc"
				else if (N[j] <= 250 && R2[k] <= .20) criterion_ = "AICc"
				else if (N[j] <= 500 && R2[k] <= .10) criterion_ = "AICc"
				else criterion_ = "BIC"
			}
			else criterion_ = criterion

			sigma = c(get_sigma_eps_ex(R2[k], coef_main=coef_main,c=0, beta_param=beta_param), get_sigma_eps_ex(R2[k], coef_main=c(coef_main[1],0,coef_main[3]),c=0, beta_param=beta_param), get_sigma_eps_ex(R2[k], coef_main=coef_main, c=c, beta_param=beta_param), get_sigma_eps_ex(R2[k], coef_main=c(coef_main[1],0,coef_main[3]),c=c, beta_param=beta_param), get_sigma_eps_ex(R2[k], coef_main=coef_main,c=10, beta_param=beta_param), get_sigma_eps_ex(R2[k], coef_main=c(coef_main[1],0,coef_main[3]),c=10, beta_param=beta_param), get_sigma_eps_ex(R2[k], coef_main=c(coef_main[1],coef_main[2],0),c=5, beta_param=beta_param))
			results = simulations_both(N = N[j], N_iter=N_iter, coef_main = coef_main, sigma = sigma, criterion = criterion_, seed = seed, crossover = crossover, boot = boot, reverse_code=reverse_code, print=print, beta_param=beta_param, c=c, include_noGxE_models=include_noGxE_models, pvalue=pvalue)
...
############## Below, this produces Figure 3 and 4  ################

# Symmetric Beta(2,2), c = 5, single genes/env
sim11 = sim_R2byN_simple(N=c(100,250,500,1000,2000), R2 = c(.05,.10,.15), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,2), c=5, include_noGxE_models=TRUE, pvalue=FALSE)
# Symmetric Beta(2,2), c = 5, multiple genes/env
sim21 = sim_R2byN(N=c(100,250,500,1000,2000), R2 = c(.10,.20,.40), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,2), c=5, include_noGxE_models=TRUE, pvalue=FALSE)
# Skewed Beta(2,4), c = 5, single genes/env
sim31 = sim_R2byN_simple(N=c(100,250,500,1000,2000), R2 = c(.05,.10,.15), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,4), c=5, include_noGxE_models=TRUE, pvalue=FALSE)
# Skewed Beta(2,4), c = 5, multiple genes/env
sim41 = sim_R2byN(N=c(100,250,500,1000,2000), R2 = c(.10,.20,.40), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,4), c=5, include_noGxE_models=TRUE, pvalue=FALSE)

# Symmetric Beta(2,2), c = 2.5, single genes/env
sim12 = sim_R2byN_simple(N=c(100,250,500,1000,2000), R2 = c(.05,.10,.15), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,2), c=2.5, include_noGxE_models=TRUE, pvalue=FALSE)
# Symmetric Beta(2,2), c = 2.5, multiple genes/env
sim22 = sim_R2byN(N=c(100,250,500,1000,2000), R2 = c(.10,.20,.40), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,2), c=2.5, include_noGxE_models=TRUE, pvalue=FALSE)
# Skewed Beta(2,4), c = 2.5, single genes/env
sim32 = sim_R2byN_simple(N=c(100,250,500,1000,2000), R2 = c(.05,.10,.15), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,4), c=2.5, include_noGxE_models=TRUE, pvalue=FALSE)
# Skewed Beta(2,4), c = 2.5, multiple genes/env
sim42 = sim_R2byN(N=c(100,250,500,1000,2000), R2 = c(.10,.20,.40), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,4), c=2.5, include_noGxE_models=TRUE, pvalue=FALSE)
...
############## Below, this produces Figure 7 of the Appendix and its single gene/env equivalent ################

# Symmetric Beta(2,2), c = 5, single genes/env
sim11 = sim_R2byN_simple(N=c(100,250,500,1000,2000), R2 = c(.05,.10,.15), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,2), c=5, include_noGxE_models=FALSE, pvalue=FALSE)
# Symmetric Beta(2,2), c = 5, multiple genes/env
sim21 = sim_R2byN(N=c(100,250,500,1000,2000), R2 = c(.10,.20,.40), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,2), c=5, include_noGxE_models=FALSE, pvalue=FALSE)
# Skewed Beta(2,4), c = 5, single genes/env
sim31 = sim_R2byN_simple(N=c(100,250,500,1000,2000), R2 = c(.05,.10,.15), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,4), c=5, include_noGxE_models=FALSE, pvalue=FALSE)
# Skewed Beta(2,4), c = 5, multiple genes/env
sim41 = sim_R2byN(N=c(100,250,500,1000,2000), R2 = c(.10,.20,.40), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,4), c=5, include_noGxE_models=FALSE, pvalue=FALSE)

# Symmetric Beta(2,2), c = 2.5, single genes/env
sim12 = sim_R2byN_simple(N=c(100,250,500,1000,2000), R2 = c(.05,.10,.15), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,2), c=2.5, include_noGxE_models=FALSE, pvalue=FALSE)
# Symmetric Beta(2,2), c = 2.5, multiple genes/env
sim22 = sim_R2byN(N=c(100,250,500,1000,2000), R2 = c(.10,.20,.40), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,2), c=2.5, include_noGxE_models=FALSE, pvalue=FALSE)
# Skewed Beta(2,4), c = 2.5, single genes/env
sim32 = sim_R2byN_simple(N=c(100,250,500,1000,2000), R2 = c(.05,.10,.15), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,4), c=2.5, include_noGxE_models=FALSE, pvalue=FALSE)
# Skewed Beta(2,4), c = 2.5, multiple genes/env
sim42 = sim_R2byN(N=c(100,250,500,1000,2000), R2 = c(.10,.20,.40), N_iter=100, criterion="BIC", reverse_code=FALSE, beta_param=c(2,4), c=2.5, include_noGxE_models=FALSE, pvalue=FALSE)
